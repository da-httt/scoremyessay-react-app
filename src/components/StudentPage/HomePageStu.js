...
const HomeStudent = (props) => {
    ...
    const columnsEssay = [
        ...
        },
        {
            ...
            key: ['essay', 'type_id'],
            width: 'auto',
            render: kind => <div style={{ color: '#2596be' }}>{types[kind].type_name}</div>,
        },
        ...
        },
        {
            ...
            (
                <div >
                    {statu === 3 && status[statu] && (<Tag color="success">{status[statu].status_name.toUpperCase()}</Tag>)}
                    {statu === 2 && status[statu] && (<Tag color="processing">{status[statu].status_name.toUpperCase()}</Tag>)}
                    {statu === 4 && status[statu] && (<Tag color="error">{status[statu].status_name.toUpperCase()}</Tag>)}
                </div>
            )
        },
        {
    ...
    return (
        < div className="student-page">
            <GlobalHeader />
            <div className="container-fluid detailPageStudent" >
                <div class="row" >
                    <div className="container-fluid leftCol" style={{ backgroundColor: "transparent" }}>
                        <div className="content-header-student padding" >
                            <div className="row bg-row margin padding"  >
                                <Breadcrumb className="mt-1" style={{ fontSize: "medium", color: "white" }}>
                                    <Breadcrumb.Item>
                            ...
                            <div className="row bg-row padding" >
                                <br />
                                <h3 className="content-header-student-title">Danh sách bài viết </h3>
                            </div>
                        </div>
                        <div className="content-student bg-row " style={{ backgroundColor: "white", padding: "10px" }}>
                    ...
                    <div className="container-fluid rightCol">
                        <div className="row bg-row" style={{ backgroundColor: "transparent" }}>
                            <div class="card" >
                                <Button className="btn-homepage" color="primary" href="/HomeStudentPage/AddNewWriting" block large>
                        ...
                        <div className="row bg-row padding card" style={{ backgroundColor: "white", padding: "20px" }}>
                            {statistics && (
                                <div className="container-fluid">
                                    <div className="row ">
                                        <div style={{ fontSize: "large", color:"#2596be", fontWeight:"900" }}>
                                            <svg xmlns="http://www.w3.org/2000/svg" style={{padding: "5px"}}width="30" height="30" fill="currentColor" class="bi bi-currency-exchange" viewBox="0 0 16 16">
                             ...
                             {statistics.gross > 0 &&
                                    ...
                                    <div className="row ">
                                        <div className="col" style={{ fontSize: '16px' }}>
                                            Mức chi trung bình:
                                            <span style={{ color: "green" }}> {statistics.monthly_payment / statistic[0].monthly_orders}</span> VND
                                        </div>
                                    </div>
                                </div>
                            )}
                        ...
                        <div className="row bg-row" style={{ backgroundColor: "transparent" }} >
                            <div className="card">
                                <div className="card-body">
                                    <div style={{ fontSize: "large", color:"#2596be", fontWeight:"900" }}>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-bar-chart-fill" viewBox="0 0 16 16" style={{ padding: "5px" }}>
                                            <path d="M1 11a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1v-3zm5-4a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v7a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V7zm5-5a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1h-2a1 1 0 0 1-1-1V2z" />
                                        </svg>
                                          Xếp hạng người dùng </div>
                                    <Table rowKey={topUsers => topUsers.user_id} columns={columnsUser} dataSource={topUsers} pagination={{ pageSize: 2, total: 5 }} />
                                </div>
                            </div>
                        </div>
                    </div>
