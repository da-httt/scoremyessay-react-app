                                ...
                                {!editAvt ?
                                    <>
                                        ...
                                        <div className="mt-2 mb-3 ml-3 mr-3">
                                            <Row>
                                                <Col sm="6">
                                                    <Button color="info" outline block onClick={handleChangeAvt}>{loadAvt ? "Đang xử lý..." : "Lưu thay đổi"}</Button>
                                                </Col>
                                                <Col sm="6">
                                                    <Button color="info" outline block onClick={e => setEditAvt(true)}>Trở lại</Button>
                                                </Col>
                                            </Row>
                                        </div>
                                    </> :
