            ...
            <div className="container-fluid detailPage" >
                <div className="row" style={{ minHeight: window.innerHeight + 'px' }}>
                    <div className="container-fluid centerCol">
                        <div className="content-header-teacher padding">
                            <div className="row bg-row margin padding" >
                                <Breadcrumb className="mt-1" style={{ fontSize: "large" }}>
                                    ...
                                    <Breadcrumb.Item style={{ color: "white" }}>Danh sách bài viết mới </Breadcrumb.Item>
                                </Breadcrumb>
                            </div>
                            <div className="row bg-row padding" >
                                <br />
                                <div className="col-8" style={{ textAlign: "left" }}><h3 style={{ color: "white", fontWeight: "700" }}>DANH SÁCH BÀI VIẾT MỚI</h3></div>
                                <div className="col-4 ">
                                    <InputGroup >
                        ...
                        <div className=" shadow-background" style={{ backgroundColor: "transparent" }}>
